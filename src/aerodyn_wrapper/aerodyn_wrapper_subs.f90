! subroutines used in aerodyn_wrapper 
module aerodyn_wrapper_subs
   
   use aerodyn_wrapper_types   
   use AeroDyn
    
   implicit none   
   
   TYPE(ProgDesc), PARAMETER   :: version   = ProgDesc( 'AeroDyn_Wrapper', '', '' )  ! The version number of this program.
                                                    
   contains

!----------------------------------------------------------------------------------------------------------------------------------
subroutine Dvr_Init(DvrData,errStat,errMsg, filename)

   type(Dvr_SimData),            intent(inout) :: DvrData       ! driver data
   integer(IntKi)              , intent(  out) :: errStat       ! Status of error message
   character(*)                , intent(  out) :: errMsg        ! Error message if ErrStat /= ErrID_None
   character(*)				   , intent(in   ) :: filename      ! filename specified in main()
   ...
   TYPE(ProgDesc), PARAMETER                   :: version   = ProgDesc( 'AeroDyn Wrapper', '', '' )  ! The version number of this program.
...
!----------------------------------------------------------------------------------------------------------------------------------
end module aerodyn_wrapper_subs
